...
> Note: Throughout this tutorial, we are going to use only GRU units as they are computationaly less expensive than LSTM units, and there are no noticeable differences between results using either of the units.
